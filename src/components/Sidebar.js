...
const WinrateGraph = require('./sidebars/WinrateGraph')
const Slider = require('./sidebars/Slider')
const GameGraph = require('./sidebars/GameGraph')
const CommentBox = require('./sidebars/CommentBox')
